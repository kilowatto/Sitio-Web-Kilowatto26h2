/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6fcf94b041e32f60a30b970b2f0c63e8)
// Runtime types generated with workerd@1.20260714.1 2026-07-19 nodejs_compat
interface __BaseEnv_Env {
	KILOWATTO_KV: KVNamespace;
	SESSION: KVNamespace;
	MEDIA: R2Bucket;
	DB: D1Database;
	VECTORIZE: VectorizeIndex;
	BRAND_FEEDBACK: VectorizeIndex;
	PHOTO_VOICE: VectorizeIndex;
	PHOTO_DEDUP: VectorizeIndex;
	BRAND_ANALYTICS: AnalyticsEngineDataset;
	AI: Ai;
