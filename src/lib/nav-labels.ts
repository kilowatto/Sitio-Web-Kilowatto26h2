export const NAV_LABELS: Record<string, Record<string, string>> = {
  "es-MX": { trayectoria: "Trayectoria", empresas: "Empresas", inversiones: "Inversiones", yucatech: "Yucatech", prensa: "Prensa", columnas: "Columnas", curiosidades: "Curiosidades", galeria: "Galería", avestruces: "Pandilla Jedi", comida: "Comida", contacto: "Contacto" },
  "es-AR": { trayectoria: "Trayectoria", empresas: "Empresas", inversiones: "Inversiones", yucatech: "Yucatech", prensa: "Prensa", columnas: "Columnas", curiosidades: "Curiosidades", galeria: "Galería", avestruces: "Pandilla Jedi", comida: "Comida", contacto: "Contacto" },
  "es-CO": { trayectoria: "Trayectoria", empresas: "Empresas", inversiones: "Inversiones", yucatech: "Yucatech", prensa: "Prensa", columnas: "Columnas", curiosidades: "Curiosidades", galeria: "Galería", avestruces: "Pandilla Jedi", comida: "Comida", contacto: "Contacto" },
  "es-ES": { trayectoria: "Trayectoria", empresas: "Empresas", inversiones: "Inversiones", yucatech: "Yucatech", prensa: "Prensa", columnas: "Columnas", curiosidades: "Curiosidades", galeria: "Galería", avestruces: "Pandilla Jedi", comida: "Comida", contacto: "Contacto" },
  "es-419": { trayectoria: "Trayectoria", empresas: "Empresas", inversiones: "Inversiones", yucatech: "Yucatech", prensa: "Prensa", columnas: "Columnas", curiosidades: "Curiosidades", galeria: "Galería", avestruces: "Pandilla Jedi", comida: "Comida", contacto: "Contacto" },
  en: { trayectoria: "Timeline", empresas: "Companies", inversiones: "Investments", yucatech: "Yucatech", prensa: "Press", columnas: "Columns", curiosidades: "Curiosities", galeria: "Gallery", avestruces: "Jedi Squad", comida: "Food", contacto: "Contact" },
  "pt-BR": { trayectoria: "Trajetória", empresas: "Empresas", inversiones: "Investimentos", yucatech: "Yucatech", prensa: "Imprensa", columnas: "Colunas", curiosidades: "Curiosidades", galeria: "Galeria", avestruces: "Turma Jedi", comida: "Comida", contacto: "Contato" },
  fr: { trayectoria: "Parcours", empresas: "Entreprises", inversiones: "Investissements", yucatech: "Yucatech", prensa: "Presse", columnas: "Chroniques", curiosidades: "Anecdotes", galeria: "Galerie", avestruces: "Bande de Jedi", comida: "Cuisine", contacto: "Contact" },
  de: { trayectoria: "Werdegang", empresas: "Unternehmen", inversiones: "Investitionen", yucatech: "Yucatech", prensa: "Presse", columnas: "Kolumnen", curiosidades: "Kurioses", galeria: "Galerie", avestruces: "Jedi-Bande", comida: "Essen", contacto: "Kontakt" },
  ar: { trayectoria: "المسيرة", empresas: "الشركات", inversiones: "الاستثمارات", yucatech: "يوكاتك", prensa: "الصحافة", columnas: "مقالات", curiosidades: "طرائف", galeria: "معرض الصور", avestruces: "عصابة الجيداي", comida: "الطعام", contacto: "اتصل بنا" },
  "zh-Hans": { trayectoria: "历程", empresas: "公司", inversiones: "投资", yucatech: "Yucatech", prensa: "新闻", columnas: "专栏", curiosidades: "趣闻", galeria: "相册", avestruces: "绝地帮", comida: "美食", contacto: "联系" },
  ja: { trayectoria: "経歴", empresas: "会社", inversiones: "投資", yucatech: "Yucatech", prensa: "プレス", columnas: "コラム", curiosidades: "こぼれ話", galeria: "ギャラリー", avestruces: "ジェダイ団", comida: "グルメ", contacto: "お問い合わせ" },
};
