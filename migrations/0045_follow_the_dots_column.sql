INSERT INTO columns (slug, title, subtitle, body_html, published_at) VALUES (
  ...
  '<p>Ayer me puse a leer algo que casi nadie lee: las notas de la versión (release notes) de la más reciente actualización de iOS. Y lo que encontré me dejó helado, no por las nuevas funcionalidades o los emojis, sino por lo que se esconde en la sección de seguridad.</p>
...
<p>¿Qué opinan? ¿Ven esta brecha de seguridad ampliándose en sus industrias?</p>',
  '2026-07-28'
);
